...
\begin{document}
	\maketitle
  	...
  	\section{Question 1}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{0.7}{\input{./images/Q1/a.tex}}
			\caption{$(p,q)=(5,9)$}
			\label{fig:59}
	  	\end{figure}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{0.7}{\input{./images/Q1/b.tex}}
			\caption{$(p,q)=(9,5)$}
			\label{fig:95}
	  	\end{figure}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{0.7}{\input{./images/Q1/c.tex}}
			\caption{$(p,q)=(17,9)$}
			\label{fig:179}
	  	\end{figure}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{0.7}{\input{./images/Q1/d.tex}}
			\caption{$(p,q)=(17,121)$}
			\label{fig:17121}
	  	\end{figure}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{0.7}{\input{./images/Q1/e.tex}}
			\caption{$(p,q)=(5,1)$}
			\label{fig:51}
	  	\end{figure}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{0.7}{\input{./images/Q1/f.tex}}
			\caption{$(p,q)=(125,1)$}
			\label{fig:1251}
	  	\end{figure}
  	...
  	\section{Question 2}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{.5}{\input{./images/Q2/sine.tikz}}
			\caption{}
			\label{fig:}
	  	\end{figure}
	  	...
	  	\begin{figure}[!htb]
			\centering
			\scalebox{.5}{\input{./images/Q2/black.tex}}
			\caption{}
			\label{fig:}
	  	\end{figure}
	...
	\section{Question 5}
		...
		\begin{figure}[!htb]
			\centering
			\scalebox{.5}{\input{./images/Q5/q5_aliasing.tikz}}
